<template>
  <div>
    ...
    <div class="sidebar">
      ...
      <ul>
        <li>All posts</li>
        <li> <router-link to="/admin/new/tos">Add New Post</router-link></li>
    ...
    <form @submit.prevent>
      ...
      <div class="main">
        <div class="main-content">
          <h6 class="fs-4 text-center mb-5">Terms of service</h6>
...
export default {
  ...
  methods: {
    modifyTos(data) {
      this.$store.dispatch("EDIT_TOS", data);
